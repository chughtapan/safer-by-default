...
| Rule | Preset | Severity | Principle anchor(s) | Rationale | Doc |
|---|---|---|---|---|---|
...
| `no-hardcoded-secrets` | `recommended` | error | [principle 2 — Validate at every boundary](../../PRINCIPLES.md#2-validate-at-every-boundary--schemas-where-data-enters-types-inside) | A hardcoded secret bypasses the env-boundary schema; secrets must be decoded at boot, not embedded in source. | [github](https://github.com/chughtapan/agent-code-guard/blob/v0.0.2/docs/rules/no-hardcoded-secrets.md) |
