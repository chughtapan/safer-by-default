...
safer-escalate --from implement-junior \
  --to <architect|implement-senior|contract> \
...
- [ ] No `any`, `as T`, or `Record<string, unknown>` in the diff.
